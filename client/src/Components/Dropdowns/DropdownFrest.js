...
class DropdwnFrest extends Component {
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({setSelectedWoodId}, dispatch);
}



export default connect(undefined, mapDispatchToProps)(DropdwnFrest);
